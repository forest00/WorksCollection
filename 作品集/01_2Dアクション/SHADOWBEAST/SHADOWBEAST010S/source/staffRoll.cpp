...
void initStaffRoll() {
	...
	hStaffRoll = imageMgrGetHandle(IMAGE_ENDING_STAFFROLE, 0);
}
...
void drawStaffRoll() {
	...
	if (i < 5040) {
		...
		SetDrawMode(AMDRAW_NOBLEND, 0);
		DrawMemThExp(0, -i, 1280, 5760 - i, hStaffRoll);
	}
	if (i >= 5040) {
		SetDrawBright(1000, 1000, 1000);
		SetDrawMode(AMDRAW_NOBLEND, 0);
		DrawMemThExp(0, -5040, 1280, 5760 - 5040, hStaffRoll);
	}
}
